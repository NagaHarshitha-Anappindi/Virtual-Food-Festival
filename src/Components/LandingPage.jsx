...
const LandingPage = () => {
    return (
        <div>
            {/* Header is removed here to avoid duplication */}
            <header className="header">
                <div style={{ marginTop: '180px', textAlign: 'center' }}>
                    <h1>Embark on a Flavorful Adventure!</h1>
                </div>
                <p style={{ textAlign: 'center' }}>Explore amazing food vendors, live events, and more!</p>
